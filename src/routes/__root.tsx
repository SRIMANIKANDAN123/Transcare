  ...
  head: () => ({
    meta: [
      ...
      { title: "TransCare — Healthcare that understands you" },
      {
        name: "description",
        content:
          "Discover inclusive, affordable and trusted healthcare services for transgender people in India — providers, benefits and support in one place.",
      },
      { name: "author", content: "TransCare" },
      { property: "og:title", content: "TransCare — Healthcare that understands you" },
      {
        property: "og:description",
        content:
          "Discover inclusive healthcare providers, affordable care, government benefits and support services in one place.",
      },
